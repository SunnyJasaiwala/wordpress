...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'ktm' ); ?></a>

	<header id="masthead" class="site-header">
		<div class="ktm-top-bar">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<?php
					...
					<div class="col-md-6 text-right">
						<div class="ktm-top-social-icons">
							<a href="<?= home_url(); ?>/opportunities-at-keys-to-me/" title="Opportunities At Keys To Me" class="ktm-top-opportunities-at-keys-to-me">
								Opportunities At Keys To Me
							</a>
						...
						</div><!-- .ktm-top-social-icons -->

						<div class="ktm-search-bar">
							<form action="<?= home_url(); ?>" method="get">
								<input type="search" name="s" id="ktm-seach-bar" placeholder="Search" autocomplete="off">
							</form>
						</div><!-- .ktm-search-bar -->
					</div>
				</div>
		...
		<div class="site-branding <?= get_field('polorized_logo') ? "has-polorized-logo" : ""; ?>">
